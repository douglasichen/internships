...
CONFIG = [
    ...
    {'company': 'Safe Superintelligence (SSI)', 'url': 'https://jobs.ashbyhq.com/ssi/b91659e4-9352-46fa-b3c5-4fb28827eb2e', 'method': 'GET', 'row_regex': '"@type":"JobPosting","title":"(?P<title>[^"]+)"', 'url_prefix': 'https://jobs.ashbyhq.com'},
    ...
    # raw string: the Deel RSC payload embeds JSON with literal \" escapes; a
    # non-raw '...\\"..' collapses to a single backslash and the class [^\\]
    # becomes an unterminated [^\] -- matching 0. Keep the id/jobId UUID
    # anchors so we hit real jobPostings, not marketing copy on the page.
    {'company': 'Klarna', 'url': 'https://jobs.deel.com/klarna', 'method': 'GET', 'row_regex': r'\\"id\\":\\"[0-9a-f-]{36}\\",\\"jobId\\":\\"[0-9a-f-]{36}\\",\\"title\\":\\"(?P<title>[^\\]+?)\\".*?\\"jobLocations\\":\[\{.*?\\"name\\":\\"(?P<loc>[^\\]+?)\\"', 'url_prefix': 'https://jobs.deel.com'},
